...
Typ in cel B1 de tekst *bin* en in de cellen B2 t/m B6 de getallen 2,4,6,8,10. Dit zijn de bovengrenzen van de intervals.

Typ in cel C1 de tekst *frequentie*. Selecteer cel C2 en voer de volgende formule in: `=INTERVAL(A2:A26;B2:B6)`.
...
Het resultaat van de intervalformule is te zien in figuur \@ref(fig:freq-interval). Om duidelijk te maken wat nu de gebruikte intervallen zijn is in de kolommen E en F een toelichting toegevoegd.
...
1. Het bestand [schoenmaten.xlsx](data/schoenmaten.xlsx) bevat de schoenmaatverdeling van 3000 Nederlandse mannen. Maak een relatieve frequentieverdeling (dus fracties) van de schoenmaten en visualiseer het resultaat met een kolomdiagram. <!-- data is gegenereerd met r-code uit datasimulatie sectie 5.2 -->
