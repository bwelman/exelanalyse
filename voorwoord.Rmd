...
+ Hoofdstuk \@ref(timeseries) legt uit wat tijdreeksen zijn, waaruit deze bestaan en hoe je een voortschrijdend gemiddelde maakt.

+ Hoofdstuk \@ref(prognoses) wordt ingegaan op een aantal mogelijkheden om prognoses (voorspellingen) van toekomstige waarden te maken.
