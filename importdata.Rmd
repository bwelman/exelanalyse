...
```{r datatype, fig.cap="Gegevenstype.", out.width="40%", fig.align='left'}
...
6. Selecteer de eerste kolom `Transaction_date` en kies dan *Gegevenstype (groep Transformeren) > Datum/Tijd*. Wanneer er een dialoogscherm komt met de vraag of de bestaande conversie vervangen moet worden, kies dan voor vervangen van de huidige conversie.
...
Webpagina's hebben vaak tabellen. De Power Query in Excel kan deze tabellen herkennen en importeren. In deze taak ga je een aantal gegevens van de UEFA Europees voetbalkampioenschap importeren die in een wikipedia pagina beschikbaar zijn.
...
```{r uefa-navigatorpane, fig.cap="Venster Navigator voor UEFA pagina op Wikipedia.", out.width="70%"}
knitr::include_graphics("images/importdata/uefa_navigatorpane.png")
```
