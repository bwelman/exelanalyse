...
```{r elftalfoto, fig.cap="Elftalfoto FC Twente, augustus 2020, © Emiel Muijderman", out.width="70%"}
...
knitr::include_graphics("images/case-fctwente/fctwente-01.png")
```
...
```{r fctwente-02, fig.cap="Startscherm Power Query Editor."}
knitr::include_graphics("images/case-fctwente/fctwente-02.png")
```
...
```{r fctwente-03, fig.cap="Kolommen verwijderd, kolomnamen gewijzigd."}
knitr::include_graphics("images/case-fctwente/fctwente-03.png")
```
...
```{r fctwente-04, fig.cap="Dialoogscherm kolom splitsen", out.width="70%"}
knitr::include_graphics("images/case-fctwente/fctwente-04.png")
```
...
```{r fctwente-05, fig.cap="Aangepaste kolom."}
knitr::include_graphics("images/case-fctwente/fctwente-05.png")
```
...
```{r fctwente-06, fig.cap="Nu met kolom Leeftijd."}
knitr::include_graphics("images/case-fctwente/fctwente-06.png")
```
...
```{r fctwente-07, out.width="100%", fig.cap="Kolom Marktwaarde opgenomen."}
knitr::include_graphics("images/case-fctwente/fctwente-07.png")
```
...
```{r fctwente-08, fig.cap="De tabel in het Excel werkblad.", out.width="70%"}
knitr::include_graphics("images/case-fctwente/fctwente-08.png")
```
