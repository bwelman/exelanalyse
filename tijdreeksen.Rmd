...
### Component Seizoen {#ts-comp-season}
...
### Component Random {#ts-comp-random}
...
### Component Cyclisch {#ts-comp-cyclic}
...
## Voorspellen in Excel {#ts-forecast}
...
+ Via afvlakkende (smoothing) werkbladfuncties welke gebruik maken van Exponential Triple Smoothing (ETS):
  - `VOORSPELLEN.ETS`
...
+ Via de opie *Exponentiele demping* (Exponential Smoothing) in *Gegevensanalyse*. Deze biedt aan  en Zwevend gemiddelde (Moving Average).
+ Via het *Voorspellingblad*.
...
### Exponentiële effening {#ts-expsmooth}
...
### Voorspellingenblad {#ts-forecastsheet}
...
+ Grafiektype (pictogrammen rechtsboven): lijndiagram of kolomdiagram
