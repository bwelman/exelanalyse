# Bijlage Aselecte getallen {#bijlage-aselect}
...
```{r aselect, fig.cap="Gegenereerde getallen met functie ASELECT."}
knitr::include_graphics("images/app-aselect/aselect.png", dpi = NA)
```
...
```{r aselecttussen, fig.cap="Gegenereerde getallen met functie ASELECTTUSSEN."}
knitr::include_graphics("images/app-aselect/aselecttussen.png", dpi = NA)
```
...
```{r aselecttussen-euro, fig.cap="Gegenereerde geldbedragen met functie ASELECTTUSSEN."}
knitr::include_graphics("images/app-aselect/aselecttussen-euro.png", dpi = NA)
```
...
```{r aselecttussen-5voud, fig.cap="Gegenereerde vijfvouden met functie ASELECTTUSSEN."}
knitr::include_graphics("images/app-aselect/aselecttussen-5voud.png", dpi = NA)
```
...
```{r aselecttussen-datums, fig.cap="Gegenereerde datums met functie ASELECTTUSSEN."}
knitr::include_graphics("images/app-aselect/aselecttussen-datums.png", dpi = NA)
```
...
```{r aselectmatrix, fig.cap="Gegenereerde getallen met functie ASELECT.MATRIX."}
knitr::include_graphics("images/app-aselect/aselectmatrix.png", dpi = NA)
```
...
```{r aselect-toolpak-discreet, fig.cap="Invulscherm Gegevensanalyse voor aselecte getallen."}
knitr::include_graphics("images/app-aselect/aselect-toolpak-discreet.png", dpi = NA)
```
...
```{r aselect-toolpak-uniform, fig.cap="Invulscherm Gegevensanalyse voor uniform verdeelde aselecte getallen."}
knitr::include_graphics("images/app-aselect/aselect-toolpak-uniform.png", dpi = NA)
```

Het resultaat ziet er ongeveer uit als volgt:

```{r aselect-toolpak-resultaat, fig.cap="Gegenereerde uniform verdeelde getallen via Gegevensanalyse."}
knitr::include_graphics("images/app-aselect/aselect-toolpak-resultaat.png", dpi = NA)
```
