...
tidy001.data %>% kbl(caption = "Starbucks koffieprijzen voor drie verschillende groottes.") %>% kable_styling(full_width = FALSE)
```
...
levensonderhoud.data %>% head(8) %>% kbl(caption = "Gemiddelde prijzen voor vier produkten.") %>% kable_styling(full_width = FALSE)
```
