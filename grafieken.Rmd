...
knitr::include_graphics("images/grafieken/freq-gegevensanalyse-instelling.png")
```
...
knitr::include_graphics("images/grafieken/freq-gegevensanalyse-resultaat.png")
```
...
knitr::include_graphics("images/grafieken/freq-grafiektype-histogram.png")
```
...
knitr::include_graphics("images/grafieken/boxplot.png")
```
...
knitr::include_graphics("images/grafieken/boxplot-tablets.png")
```
...
::: {.sectionexercise}
1. Maak in een Excel werkblad de boxplot uit figuur \@ref(fig:boxplot-tablets). De data is in bestand [tablets.xlsx](data/tablets.xlsx).
...
```{r groepslengtes, fig.cap="Lengtes (cm) van twee groepen van elk 50 personen.", out.width="70%"}
knitr::include_graphics("images/grafieken/groepslengtes.png")
```
