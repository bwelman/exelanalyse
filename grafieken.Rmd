...
1. Zijn de gegevens symmetrisch of scheef1Zijn er uitschieters in de gegevens?
...
Ook hier moet je net als bij de functie INTERVAL (\@ref(intervalfunctie)) een bereik voor de grenzen van de intervallen maken.
...
knitr::include_graphics("images/freq-gegevensanalyse-instelling.png", dpi = NA)
```
...
knitr::include_graphics("images/freq-gegevensanalyse-resultaat.png", dpi = NA)
```
...
knitr::include_graphics("images/freq-grafiektype-histogram.png", dpi = NA)
```
...
knitr::include_graphics("images/boxplot.png", dpi = NA)
```
...
knitr::include_graphics("images/boxplot-tablets.png", dpi = NA)
```
...
knitr::include_graphics("images/groepslengtes.png", dpi = NA)
```
