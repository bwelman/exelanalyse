...
```{r toolpak-regressie, fig.cap="Dialoogscherm regressie.", out.width="70%"}
...
```{r sim1-samenvatting, echo=FALSE, fig.cap="Samenvatting regressie.", out.width="70%"}
...
sim2.data %>% 
	kbl(digits = 1, format.args = list(decimal.mark = ","), caption = "Temp-Druk") %>% 
...
```{r sim2-spreiding, fig.cap="Spreidingsdiagram in Excel met vergelijking lijn.", out.width="70%"}
...
```{r sim2-samenvatting, fig.cap="Samenvatting regressie.", out.width="70%"}
...
```{r ecdata-samenvatting, fig.cap="Samenvatting regressie meervoudige lineaire regressie.", out.width="70%"}
