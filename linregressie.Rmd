# Samenhang en lineaire regressie {#regressie}
...
```{r sim1-data, fig.cap="Dataset met 15 waarnemingen x en y."}
knitr::include_graphics("images/sim1-data.png")
```
...
knitr::include_graphics("images/sim1-basis.png")
```
...
knitr::include_graphics("images/sim1-regressie.png")
```
...
knitr::include_graphics("images/sim1-spreiding.png")
```
...
knitr::include_graphics("images/toolpak-regressie.png")
```
...
knitr::include_graphics("images/sim1-samenvatting.png")
```
...
knitr::include_graphics("images/sim1-anova.png")
```
...
knitr::include_graphics("images/sim1-coefficienten.png")
```
...
knitr::include_graphics("images/sim1-residuen.png")
knitr::include_graphics("images/sim1-residuplot.png")
```
...
```{r sim2-data, fig.cap="Experiment met 10 waarnemingen temperatuur en druk."}
knitr::include_graphics("images/sim2-data.png")
```
...
knitr::include_graphics("images/sim2-spreiding.png")
```
...
knitr::include_graphics("images/sim2-samenvatting.png")
```
...
knitr::include_graphics("images/sim2-coefficienten.png")
```
...
knitr::include_graphics("images/sim2-residuen.png")
knitr::include_graphics("images/sim2-residuplot.png")
```
...
knitr::include_graphics("images/sim2-polynoom2.png")
```
...
knitr::include_graphics("images/ecdata.png")
```
...
knitr::include_graphics("images/ecdata-rel1.png")
knitr::include_graphics("images/ecdata-rel2.png")
```
...
knitr::include_graphics("images/ecdata-regressie.png")
```

Vervolgens wordt een regressie-analyse via Gegevensanalyse uitgevoerd.

```{r ecdata-samenvatting, fig.cap="Samenvatting regressie meervoudige lineaire regressie."}
knitr::include_graphics("images/ecdata-samenvatting.png")
```
...
knitr::include_graphics("images/ecdata-coefficienten.png")
```
...
knitr::include_graphics("images/ecdata-residu1.png")
knitr::include_graphics("images/ecdata-residu2.png")
```
...
::: {.sectionexercise}
1. In \@ref(linreg-enkelvoudig) is een regressie-analyse besproken met de data in figuur \@ref(fig:sim1-data). Voer deze analyse in Excel uit. Experimenteer met de uitvoeropties die Gegevensanalyse biedt. De dataset kun je ook downloaden als [sim1.csv](data/sim1.csv).
