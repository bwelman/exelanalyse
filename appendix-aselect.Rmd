...
knitr::include_graphics("images/aselect.png", dpi = NA)
```
...
knitr::include_graphics("images/aselecttussen.png", dpi = NA)
```
...
knitr::include_graphics("images/aselecttussen-euro.png", dpi = NA)
```
...
knitr::include_graphics("images/aselecttussen-5voud.png", dpi = NA)
```
...
knitr::include_graphics("images/aselecttussen-datums.png", dpi = NA)
```
...
knitr::include_graphics("images/aselectmatrix.png", dpi = NA)
```
...
knitr::include_graphics("images/aselect-toolpak-discreet.png", dpi = NA)
```
...
knitr::include_graphics("images/aselect-toolpak-uniform.png", dpi = NA)
```
...
knitr::include_graphics("images/aselect-toolpak-resultaat.png", dpi = NA)
```
